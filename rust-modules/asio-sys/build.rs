...
fn create_bindings(cpal_asio_dir: &PathBuf) {
    ...
    let bindings = bindgen::Builder::default()
        ...
        .allowlist_type("ASIOIoFormatType_e")
        .allowlist_type("ASIOTimeCodeFlags")
        .allowlist_var("kASIODSDFormat")
        .allowlist_var("kAsioCanDoIoFormat")
        .allowlist_var("kAsioSetIoFormat")
        .allowlist_var("kAsioGetIoFormat")
        ...
        .allowlist_function("ASIOCanSampleRate")
        .allowlist_function("ASIOSetSampleRate")
        .allowlist_function("ASIOGetSampleRate")
      ...
      //  .bitfield_enum("ASIOIoFormatType_e")
